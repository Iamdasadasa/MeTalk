...
import UIKit
protocol  AboutMeTextFieldModalViewDelegateProtcol:AnyObject {
...
class   AboutMeTextFieldModalView:UIView{
...
//※各定義※
    ///変数宣言
    weak var delegate: AboutMeTextFieldModalViewDelegateProtcol?
...
///テキストフィールド装飾
extension AboutMeTextFieldModalView{
    ///テキストフィールドの枠線を自作
