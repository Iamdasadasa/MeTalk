...
//    ///インスタンス化(Model)
//    let TALKLOCAL = MessageLocalGetterManager()
//    let PROFILEGETTER = ProfileHostGetter()
//    let CHATGETTER = ListDataHostGetter()
////    let CONTENTSGETTER = contentOfFIRStorageGet()
////    let LOCALCONTENTSSTRUCT = contentsl
...
//    ///トークリストユーザー情報格納配列
//    var talkListUsersMock:[listUsersInfoLocalObject] = []
//    
//    ///ビューが表示されるたびに実行する処理群
